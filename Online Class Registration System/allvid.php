  ...
  <div class="table-responsive">
    <div class="table-wrapper">
      ...
      <table class="table table-striped table-hover" id="editable_table">
        ...
        $sql="SELECT department.*,videos.* from department INNER JOIN videos ON   department.Dept_ID=videos.Dept_ID";
        $i=1;
          ...
          <tr>
            ...
            <td><?php foreach ($conn->query($sql1) as $row1) { echo $row1['Subject']; } ?></td>
             <td><?php echo $row['title'] ?></td>
              <td><a href="<?php echo $row['link'] ?>">Click Here to watch the Video</a></td>
            <td>  <a href="videdit.php?edit=<?php echo $row['vid']; ?>" class="edit" name='edit'><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a> </td>
