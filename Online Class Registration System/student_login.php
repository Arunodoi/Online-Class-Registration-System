...
<div class="container">
  ...
  <h2>Student Login</h2>
   ...
   <div class="row mb-4 px-3"> <small class="font-weight-bold">Don't have an account? <a href="new_student.php" class="text-danger ">Register</a></small> </div>
...
include 'connect.php';
         ...
         if (isset($_POST['B'])) {
                        ...
                        $password=$_POST['password'];
                            ...
                            $sql = $conn->prepare("SELECT * from student where smob='$username' and spass='$password'");

                            $sql->execute();



                            $sql3="SELECT * from student where smob='$username' and spass='$password' "; 
                            ...
                            $_SESSION['user'] = $row['sid']; 
                            $_SESSION['user2'] = $row['sname'];
                            session_write_close();
                             }
